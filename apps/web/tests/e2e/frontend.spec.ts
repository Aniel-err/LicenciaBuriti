...
async function mockApi(page: Page, role = "ADMIN") {
  await page.route("http://localhost:3333/**", async (route) => {
    ...
    const bodies: Record<string, unknown> = {
      ...
      "/catalog/fees": [], "/inspections": [], "/document-templates": [], "/admin/users": [], "/admin/audit": [],
      ...
      "/public/licenses/CODIGO-VALIDO-1234": { number: "LIC-001", type: "LUA", issuedAt: "2026-07-01", validUntil: "2027-07-01", signedBy: "Secretária", process: "2026.000001", protocol: "BURITI-2026-000001", enterprise: "Unidade Ambiental", entrepreneur: "Empresa Buriti", status: "Licença emitida" }
    };
